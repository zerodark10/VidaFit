...
<link href="https://fonts.googleapis.com/css2?family=Spartan:wght@600&display=swap" rel="stylesheet">
  ...
  <section>
          ...
          <div class="container-fluid mb-5 ">
            <div class="row ">
             ...
             <div class="col-sm-9  col-8 col-md-9 col-lg-9 col-xl-10 ">  
               <img src="img/user.png"class="img-fluid input radius logo" alt="logo">
               </div>
            <div class="col-sm-3 col-4 col-md-3  col-lg-3 col-xl-2 p-1">
               <img src="img/logo.png" class="img-fluid input radius logo"  alt="user" >
            </div>   
      ...
      <button type="submit" value="Send" name="registrar" class="btn btn-primary w-100 radius ">Guardar</button>
