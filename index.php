...
<meta name="google-signin-scope" content="profile email">
    <meta name="google-signin-client_id" content="321415945903-teo2naorslio961vquk8pmi4qvru17fk.apps.googleusercontent.com">
  ...
  <section> <video class="bg-video  radius-card" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop"><source src="mp4/bg.mp4" type="video/mp4" /></video>
      ...
      <br><br><br><br>
            <div class="px-lg5 py-lg4 p-4 w-100 aling-self-center bg-dark-x  radius-card ">
                ...
                <form class="mb-5" action="<?php $_SERVER["PHP_SELF"];?>" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary w-100 radius mb-2 "><a href="home.html"> <p class="text-white"> Iniciar sesion</p> </a>
                   </button>
                  ...
                  <div class="d-flex justify-content-around">
                    ...
                    <button type="submit"  data-onsuccess="onSignIn"  class="btn btn-outline-light flex-grow-1 input mr-4 "><i class="fab fa-google lead mr-4"></i> Google</button>
                    <button type="submit"  onclick="onLogin();" class="btn btn-outline-light flex-grow-1 input ml-4"><i class="fab fa-facebook lead mr-4"></i> Facebook</button>
                  </div>
            </div>
            <div class="text-center px-lg-5 pt-lg-3 pb-lg-4 p-4 w-100 mb-auto">
              <p class="d-inline-block mb-0 ">Aun no tienes una cuenta?</p> 
              <a href="registro.html" class=" font-weight-bold text-decoration-none ">Crear una </a>
              <div>
    ...
    <script>
      ...
      chatbox.setAttribute("page_id", "106334541843545");
